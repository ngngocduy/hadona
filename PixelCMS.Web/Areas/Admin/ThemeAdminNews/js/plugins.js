$(document).ready(function(){
    ...
    //FORM VALIDATION
        ...
        $("#validation").validationEngine({promptPosition : "topLeft", scroll: true});    
				$("#validation-2").validationEngine({promptPosition : "topLeft", scroll: true});     
    ...
    $("#b_popup_4").dialog({autoOpen: false, 
        ...
        $("#popup_4").click(function(){$("#b_popup_4").dialog('open')});
						...
						// Dialog Properties of Product 
		$("#popup-add-properties").dialog({autoOpen: false, 
                            modal: true,
                            width: 400,
                            buttons: {                            
                                "Ok": function() {
        ...
        $("#add-properties").click(function(){$("#popup-add-properties").dialog('open')});
   ...
   // TOOLTIPSborder:{
        ...
        // WYSIWIG HTML EDITOR
            if($("#wysiwyg").length > 0){
                ...
                editor = $("#detail-content").cleditor({width:"100%", height:"300px"})[0].focus();                
            } 
						
						if($("#warranty").length > 0){
                editor = $("#warranty").cleditor({width:"100%", height:"100%"})[0].focus();                
            } 
						
						if($("#payment").length > 0){
                editor = $("#payment").cleditor({width:"100%", height:"100%"})[0].focus();                
            }                                         
            
         // Sortable table
         if($("#tSortable").length > 0)
         {
            $("#tSortable").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, { "bSortable": false }, null, { "bSortable": false }, { "bSortable": false }]});
            $("#tSortable_2").dataTable({"iDisplayLength": 5, "sPaginationType": "full_numbers","bLengthChange": false,"bFilter": false,"bInfo": false,"bPaginate": true, "aoColumns": [ { "bSortable": false }, null, { "bSortable": false }, null,{ "bSortable": false }, { "bSortable": false }]});
         }
				 
				 // table Categories List
         if($("#tableCategoriesList").length > 0)
         {
            $("#tableCategoriesList").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, { "bSortable": false }, null, { "bSortable": false }, { "bSortable": false }]});
         }
				 
				 // Table Products List
         if($("#tableProductsList").length > 0)
         {
            $("#tableProductsList").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, { "bSortable": false }, null, null, null, { "bSortable": false }, { "bSortable": false }]});
            
         }
				 
				 // table Properties List
         if($("#tablePropertiesList").length > 0)
         {
            $("#tablePropertiesList").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, { "bSortable": false }, { "bSortable": false }, { "bSortable": false } ]});
         }
